...
#This is a modified version of the MOVO script located in si_utils.base_motion_test
...
class BaseMotion(object):
    ...
    def _motion_vel(self, vel_cmd, duration):
        ...
        #In our case, the angular motion is already in radians
        twist_cmd.angular.z = vel_cmd[2]
